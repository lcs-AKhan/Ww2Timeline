        ...
        var topLevelOptions = [
            ...
            Year(name: "1939", children: [
                ...
                Event(name: "Hitler Invades Poland",
                      ...
                      imageName: "Hitler", troops: ""),
                Event(name: "Canada Declares War",
                      date: "September 10, 1939",
                      description: "Canada officially declares war on Germany. This is the first time Canada has declared war on another country as an independent country. Little did the Allies know that Canada would be one of the biggest contributors to the defeat of Hitler. But of course, none of the Canadians were looking forward to having another large war.",
                      imageName: "CanadaDeclaresWar", troops: ""),
                Event(name: "Conscription In Canada",
                      ...
                      imageName: "ConscriptionWw2", troops: ""),
            ...
            Year(name: "1941", children: [
                ...
                Event(name: "Battle of Hong Kong",
                      ...
                      troops: "Troops Involved: On 11 December, the men of 'D' company of the Winnipeg Grenadiers became the first Canadian Army troops to engage in combat in the war."),
            ...
            Year(name: "1942", children: [
                ...
                Event(name: "Dieppe raid",
                      ...
                      imageName: "Dieppe",
                      troops: "Troops involved: The Royal Hamilton Light Infantry, Essex Scottish, Fusiliers Mont-Royal, Royal Marine 'A' Commando, 14th Canadian Army Tank Regiment (Calgary Regiment), Calgary Highlanders and Toronto Scottish Regiment."),
            ...
            Year(name: "1943", children: [
                ...
                Event(name: "Battle of Sicily",
                      ...
                      troops: "Troops involved: 1st Canadian Infantry Division and the 1st Canadian Armoured Brigade"),
                Event(name: "Battle of Ortona",
                      ...
                      troops: "Troops involved: The Loyal Edmonton Regiment’s “D” Company, reinforced by the Seaforth Highlanders of Canada and tanks of the Three Rivers Regiment"),
            ]),
            Year(name: "1944", children: [
                ...
                Event(name: "Liri Valley",
                      ...
                      imageName: "LiriValley", troops: "Troops involved: The 1st Canadian Corps, Canadian paratroopers of the 1st Special Service Force."),
                Event(name: "D-Day",
                      date: "June 6, 1944",
                      ...
                      imageName: "D-Day", troops: "Troops involved: The Royal Canadian Navy"),
                Event(name: "Liberation of Paris",
                      ...
                      imageName: "ParisLiberation", troops: ""),
